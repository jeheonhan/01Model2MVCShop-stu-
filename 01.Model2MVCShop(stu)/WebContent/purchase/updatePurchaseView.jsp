...
<script type="text/javascript">
	function fncUpdatePurchase() {
		//Form 유효성 검증
		var name = document.updatePurchase.receiverName.value;
		var phone = document.updatePurchase.receiverPhone.value;
		var addr = document.updatePurchase.receiverAddr.value;
		var date = document.updatePurchase.receiverDate.value;
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverName"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20" value="<%=purchaseVO.getReceiverName()%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverPhone"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20" value="<%=purchaseVO.getReceiverPhone()%>" /></td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverAddr"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20" value="<%=purchaseVO.getDivyAddr()%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
